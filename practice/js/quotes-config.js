...
const QUOTES = [
  ...
  {
    text: "We can’t just let go by an act of will. It takes wisdom. Wisdom and the insight into impermanence. Only then can we start to drop things.",
    author: "Ajahn Nyaniko",
    source: "Talk: Dhamma-Vinaya is the priority. 26-07-2026",
    themes: [
      "letting-go"
    ]
  }
