...
const SUTTAS = [
  ...
  },
  {
    ...
    note: "From a young age I was drawn to American hip-hop. I was enchanted by the stories the artists told about sex, crime and life in poverty, but also by the social issues they seemed to shine a light on. Some of these artists I really looked up to, even though my own life looked nothing like theirs.\n\nThen, in the mid-nineties, two famous rappers I loved listening to were killed. Looking back, their deaths could have been divine messengers for me. The message was there, but I didn't receive it. For years afterwards I continued to look up to rappers and to see their wealth and status as something worth striving for, while overlooking behavior that now seems clearly at odds with how I understand morality.\n\nMaybe it was getting older myself, and eventually growing older than either of those two rappers ever became, that started to make the message more real. This life is fleeting. And looking back, I can also see that I have lived much of my life in abundance without really realizing it. There were times when I had little money, but I cannot say that I have ever truly lived in poverty. Yet that abundance has never brought me very much happiness. Slowly, perhaps, I started to understand what those divine messengers had been telling me all along.\n\nAnd then there was my trip to Wat Chom Tong. I saw monks devoting their lives to practice, while giving thousands of lay people the opportunity to learn and practice themselves. For me, that was something different. Aging and death had begun to show me that my time was limited; at Wat Chom Tong I saw something worthwhile to do with that time.\n\nIt showed me that, even though walking this path is not easy, it seems worth trying.",
    added: "2026-08-09"
  },
  ...
  // 2. The Tribulations of Unreflective Living
  {
    ...
    note: "We will all experience suffering in our lives in one form or another. In that sense, getting struck by the \"first arrow\" is unavoidable. We age, we get sick and, at some point, we will all die. Along the way there will inevitably be painful and uncomfortable feelings.\n\nThe \"second arrow\" took me a while to comprehend. It seems easy to tell ourselves not to wail and lament over the pain we are feeling, only to catch ourselves wailing and lamenting again a few minutes later. It is not about telling ourselves to \"toughen up\" or \"get over it already\". That can become its own form of struggling with what we feel. Nor is it much help to tell someone else to \"get a grip\" or \"lighten up\". We can only begin to understand this through our own investigation.\n\nMindfulness gives us a way to make that investigation. We learn to know when we are walking, standing, sitting or lying down. These are the four postures to be mindful of, but that knowing can extend throughout our experience: knowing when we are touching, eating, talking or feeling. In the vipassana practice I was taught, I began to understand this less as an idea and more as something observable. When an unpleasant feeling arises, I can sometimes see not only the feeling itself, but also what the mind starts doing with it. That is where the second arrow becomes something I can actually recognize.\n\nI am not saying that I am completely free from suffering. What I can say is that life has become easier since I have been able to put down the second arrow sooner than I could before.",
    added: "2026-08-20"
  },
  {
    id: "itbw-1-2-2",
  ...
  // --- Reflections on Suttas That Stay With Me ---
  {
    ...
    note: "Who doesn't love to philosophize about life? Probably a lot of people don't. But for most of my life, I enjoyed it. Or maybe enjoyment is the wrong word to describe it, because at times I even took it too far. Always questioning everything. So much that my head would hurt.\n\nI wanted to know why and how the world worked, how and why we move through it as we do, and sometimes the most important thing was to find out who was responsible. Who was responsible for this war, or that conspiracy, or even worse, who was responsible for my suffering. Because that surely could not be me, right?\n\nOver time I started to notice how often these questions depended on very solid ideas about myself and other people. <em>They </em>did this. <em>I</em> was wronged. <em>They </em>should have acted differently. <em>I</em> should not have to feel this way. The stories could become very elaborate, while the actual experience in front of me was usually much simpler: thoughts, feelings, intentions, reactions, all arising because of conditions and changing again. \n\nVajirā’s reply to Māra points in a different direction. What we call a \"being\" is not something solid that can be found apart from the conditions that make up our experience. Yet I keep turning myself and other people into fixed characters in the stories I tell about what happens. \n\nWhen we say “let it go”, it does not mean we should not care. It means that grasping at our ideas on how it should be prevents us from actually caring for what is in front of us. ",
    added: "2026-08-12"
  },
  {
    id: "keepers-2",
