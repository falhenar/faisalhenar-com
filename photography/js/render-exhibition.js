...
function renderPhotography() {
  ...
  */
  ...
  // migration. If that migration path is ever triggered again (it
  // rewrites this file wholesale when a legacy-date-sort indexOrder is
  // detected alongside a dirty index-order draft), verify this block
  ...
  // collection (Index photos not already shown), in Index order. Opening
  // from the Index itself is unaffected — it still uses indexItems below,
  // self-contained.
